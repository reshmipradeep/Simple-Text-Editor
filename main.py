...
from textarea import CustomText
...
class Text(tk.Frame):
    def __init__(self, *args, **kwargs):
        ...
        self.font_style = tk_font.Font(family=self.font_family, size=self.font_size)
    ...
    # editor  mode calling which removes status bar and menu bar
    def enter__mode(self, *args):
    ...
    def set_window_title(self, name=None):
        if name:
            self.master.title(f'{name} -  Text')
        else:
            self.master.title('untitled -  Text')
    ...
    def bind_shortcuts(self, *args):
        ...
        text.bind('<Control-q>', self.enter__mode)
        ...
        text.bind('<Escape>', self.leave__mode)
